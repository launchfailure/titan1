...
Contributions should preserve Titan's deterministic, bounded, and explainable behavior.

## Before coding

Open or reference an issue for substantial changes. Identify the owning subsystem, existing report contract, and security boundary. Avoid combining unrelated refactors with behavior changes.
...
Use clear commits that can be reviewed independently. Generated reports, extracted patch packages, virtual environments, caches, and local vault data should not be committed.
